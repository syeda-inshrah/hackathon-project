...
const menuItems = ["Home", "Services", "Features", "Stats", "Testimonials"] as const
...
export default function Header() {
  ...
  const scrollToSection = (section: (typeof menuItems)[number]) => {
    setActiveTab(section.toLowerCase())
    const el = document.getElementById(section.toLowerCase())
    if (el) el.scrollIntoView({ behavior: "smooth", block: "start" })
  }

  const [activeTab, setActiveTab] = useState<(typeof menuItems)[number] | string>("home")
      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-white">Emergency Response AI</span>
          </div>
